...
namespace Yunt.XmlProtocol.Domain.Models
{
    ...
    /// <remarks></remarks>
    public partial class Motorparams : Entity<Motorparams>
    {
        #region 对象操作
            ﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}[{1}]数据……", typeof(Motorparams).Name, Meta.Table.DataTable.DisplayName);
        ...
        //    entity.PhysicFeature = "abc";
        //    entity.Insert();

        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}[{1}]数据！", typeof(Motorparams).Name, Meta.Table.DataTable.DisplayName);
        //}
        ...
        /// <returns>实体集</returns>
        public static IList<Motorparams> Search(Int32 userid, DateTime start, DateTime end, String key, PageParameter param)
        {
