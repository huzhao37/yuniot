...
namespace Yunt.XmlCheck.Models
{
    ...
    public partial class DataFormModel : Entity<DataFormModel>
    {
        ...
        protected override void InitData()
        {
			...
			//entity.MotorOrderIndex = 0;
			//entity.Unit = "abc";
			//entity.DataRange = "abc";
			//entity.StartRegisterAddress = "abc";
			//entity.EndRegisterAddress = "abc";
			//entity.StartBit = "abc";
			//entity.EndBit = "abc";
			//entity.DataType = "abc";
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static IList<DataFormModel> FindByProLineId(Int32 pId, string configId)
        {
            if (Meta.Count >= 1000)
                return FindAll(new [] { __.LineId, __.DataConfigId },
                    new object[] { pId, configId });
            else // 实体缓存
                return Meta.Cache.Entities.FindAll(e => e.LineId == pId && e.DataConfigId.EqualIgnoreCase(configId));
            // 单对象缓存
            //return Meta.SingleCache[id];
        }
         ...
         /// <summary>根据ProLineId和电机名称查找</summary>
             ...
             /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static IList<DataFormModel> FindByLineIdAndMachineName(Int32 pId, string motorName)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static IList<DataFormModel> FindByLineIdAndMachineName(Int32 pId, string motorName,string dataType)
        {
            //九江新产线反击破需要
            if (motorName.Contains("反击破") && pId == 189)
                dataType = "模拟量";
            ...
            if (Meta.Count >= 1000)
              ...
              return Meta.Cache.Entities.FindAll(e => e.LineId == pId && e.MachineName.Equals(motorName)&&e.DataType.Contains(dataType));
