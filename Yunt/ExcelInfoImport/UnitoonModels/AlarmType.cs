...
{
    /// <summary>AlarmType</summary>
    /// <remarks></remarks>
    [Serializable]
    [DataObject]
    [Description("")]
    [BindTable("AlarmType", Description = "", ConnName = "unitoon_configmanager", DbType = DatabaseType.SqlServer)]
    public partial class AlarmType : IAlarmType
    {
        #region 属性
        private Int32 _Id;
        /// <summary></summary>
        ...
        [Description("")]
        [DataObjectField(false, false, true, -1)]
        [BindColumn("Maintenance", "", "nvarchar(-1)")]
        public virtual String Maintenance
        {
            get { return _Maintenance; }
            set { if (OnPropertyChanging(__.Maintenance, value)) { _Maintenance = value; OnPropertyChanged(__.Maintenance); } }
        }
        ...
        public override Object this[String name]
        {
            get
            {
                switch (name)
                {
                    ...
                    case __.Maintenance : return _Maintenance;
            ...
            set
            {
                switch (name)
                {
                    ...
                    case __.Maintenance : _Maintenance = Convert.ToString(value); break;
        ...
        #region 字段名
        /// <summary>取得AlarmType字段信息的快捷方式</summary>
        public partial class _
        {
            ...
            ///<summary></summary>
            public static readonly Field Maintenance = FindByName(__.Maintenance);
        ...
        /// <summary>取得AlarmType字段名称的快捷方式</summary>
        partial class __
        {
            ///<summary></summary>
    ...
    /// <summary>AlarmType接口</summary>
    /// <remarks></remarks>
    public partial interface IAlarmType
    {
        #region 属性
        /// <summary></summary>
        Int32 Id { get; set; }
