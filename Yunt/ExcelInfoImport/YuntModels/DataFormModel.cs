...
namespace ExcelInfoImport.YuntModels
{
    ...
    [DataObject]
    [Description("")]
    [BindTable("dataformmodel", Description = "", ConnName = "yunt_xml", DbType = DatabaseType.MySql)]
        ...
        public override Object this[String name]
        {
            get
            {
                switch (name)
                {
                    ...
                    case __.FormatId : return _Remark;
            ...
            set
            {
                switch (name)
                {
                    ...
                    case __.Value : _Value = Convert.ToSingle(value); break;
