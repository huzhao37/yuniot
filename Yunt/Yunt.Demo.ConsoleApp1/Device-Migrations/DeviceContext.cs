...
namespace Yunt.Demo.ConsoleApp1
{
    ...
    public partial class DeviceContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ConeCrusher>().Property(u => u.MotorId).HasMaxLength(20).IsRequired();
            ...
            modelBuilder.Entity<ConeCrusherByHour>().Property(u => u.MotorId).HasMaxLength(20).IsRequired();
            modelBuilder.Entity<ConeCrusherByDay>().HasIndex(u => new {u.Time , u.MotorId });
            modelBuilder.Entity<ConeCrusherByDay>().Property(u => u.MotorId).HasMaxLength(20).IsRequired();
            modelBuilder.Entity<HVib>().HasIndex(u => new {u.Time , u.MotorId });
            modelBuilder.Entity<HVib>().Property(u => u.MotorId).HasMaxLength(20).IsRequired();
            modelBuilder.Entity<HVibByHour>().HasIndex(u => new {u.Time , u.MotorId });
            modelBuilder.Entity<HVibByHour>().Property(u => u.MotorId).HasMaxLength(20).IsRequired();
            modelBuilder.Entity<HVibByDay>().HasIndex(u => new {u.Time , u.MotorId });
            modelBuilder.Entity<HVibByDay>().Property(u => u.MotorId).HasMaxLength(20).IsRequired();
            modelBuilder.Entity<Motor>().HasIndex(u => new { u.MotorId, u.MotorTypeId,u.EmbeddedDeviceId });
            modelBuilder.Entity<Motor>().Property(u => u.MotorId).HasMaxLength(20).IsRequired();
            ...
            modelBuilder.Entity<Conveyor>().Property(u => u.MotorId).HasMaxLength(20).IsRequired();
            modelBuilder.Entity<ConveyorByDay>().HasIndex(u => new {u.Time , u.MotorId });
            modelBuilder.Entity<ConveyorByDay>().Property(u => u.MotorId).HasMaxLength(20).IsRequired();
            modelBuilder.Entity<ConveyorByHour>().HasIndex(u => new {u.Time , u.MotorId });
            modelBuilder.Entity<ConveyorByHour>().Property(u => u.MotorId).HasMaxLength(20).IsRequired();        
            modelBuilder.Entity<ImpactCrusher>().Property(u => u.MotorId).HasMaxLength(20).IsRequired();
            modelBuilder.Entity<ImpactCrusher>().HasIndex(u => new {u.Time , u.MotorId });
            modelBuilder.Entity<ImpactCrusherByDay>().Property(u => u.MotorId).HasMaxLength(20).IsRequired();
            modelBuilder.Entity<ImpactCrusherByDay>().HasIndex(u => new {u.Time , u.MotorId });
            modelBuilder.Entity<ImpactCrusherByHour>().Property(u => u.MotorId).HasMaxLength(20).IsRequired();
            modelBuilder.Entity<ImpactCrusherByHour>().HasIndex(u => new {u.Time , u.MotorId });
            modelBuilder.Entity<JawCrusher>().Property(u => u.MotorId).HasMaxLength(20).IsRequired();
            modelBuilder.Entity<JawCrusher>().HasIndex(u => new {u.Time , u.MotorId });
            modelBuilder.Entity<JawCrusherByDay>().Property(u => u.MotorId).HasMaxLength(20).IsRequired();
            modelBuilder.Entity<JawCrusherByDay>().HasIndex(u => new {u.Time , u.MotorId });
            modelBuilder.Entity<JawCrusherByHour>().Property(u => u.MotorId).HasMaxLength(20).IsRequired();
            modelBuilder.Entity<JawCrusherByHour>().HasIndex(u => new {u.Time , u.MotorId });
            modelBuilder.Entity<MaterialFeeder>().Property(u => u.MotorId).HasMaxLength(20).IsRequired();
            modelBuilder.Entity<MaterialFeeder>().HasIndex(u => new {u.Time , u.MotorId });
            modelBuilder.Entity<MaterialFeederByHour>().Property(u => u.MotorId).HasMaxLength(20).IsRequired();
            modelBuilder.Entity<MaterialFeederByHour>().HasIndex(u => new {u.Time , u.MotorId });
            modelBuilder.Entity<MaterialFeederByDay>().Property(u => u.MotorId).HasMaxLength(20).IsRequired();
            modelBuilder.Entity<MaterialFeederByDay>().HasIndex(u => new {u.Time , u.MotorId });
            //modelBuilder.Entity<Motor>().Property(u => u.MotorId).HasMaxLength(20).IsRequired();
            //modelBuilder.Entity<MaterialFeederByHour>().HasIndex(u => new {u.Time , u.MotorId });
            //modelBuilder.Entity<Motor>().Property(u => u.MotorId).HasMaxLength(20).IsRequired();
            //modelBuilder.Entity<MaterialFeederByDay>().HasIndex(u => new {u.Time , u.MotorId });
            modelBuilder.Entity<Pulverizer>().Property(u => u.MotorId).HasMaxLength(20).IsRequired();
            modelBuilder.Entity<Pulverizer>().HasIndex(u => new {u.Time , u.MotorId });
            modelBuilder.Entity<PulverizerByDay>().Property(u => u.MotorId).HasMaxLength(20).IsRequired();
            modelBuilder.Entity<PulverizerByDay>().HasIndex(u => new {u.Time , u.MotorId });
            modelBuilder.Entity<PulverizerByHour>().Property(u => u.MotorId).HasMaxLength(20).IsRequired();
            modelBuilder.Entity<PulverizerByHour>().HasIndex(u => new {u.Time , u.MotorId });
            modelBuilder.Entity<VerticalCrusher>().Property(u => u.MotorId).HasMaxLength(20).IsRequired();
            modelBuilder.Entity<VerticalCrusher>().HasIndex(u => new {u.Time , u.MotorId });
            modelBuilder.Entity<VerticalCrusherByDay>().Property(u => u.MotorId).HasMaxLength(20).IsRequired();
            modelBuilder.Entity<VerticalCrusherByDay>().HasIndex(u => new {u.Time , u.MotorId });
            modelBuilder.Entity<VerticalCrusherByHour>().Property(u => u.MotorId).HasMaxLength(20).IsRequired();
            ...
            modelBuilder.Entity<Vibrosieve>().Property(u => u.MotorId).HasMaxLength(20).IsRequired();
            modelBuilder.Entity<VibrosieveByDay>().HasIndex(u => new {u.Time , u.MotorId });
            modelBuilder.Entity<VibrosieveByDay>().Property(u => u.MotorId).HasMaxLength(20).IsRequired();
            modelBuilder.Entity<VibrosieveByHour>().HasIndex(u => new {u.Time , u.MotorId });
            modelBuilder.Entity<VibrosieveByHour>().Property(u => u.MotorId).HasMaxLength(20).IsRequired();
