...
namespace Yunt.Dtsc.Core
{
    public class JobHelper
    {
        ...
        public static void JoinToQuartz(Type type, TbJob job ,Dictionary<string, object> param = null)
        {
            ...
            Dictionary.Add(name, jobDetail.Key);
        ...
        public static Type GetJobType(int jobid)
        {
            ...
            if (job == null)
                return null;
            var path = Path.GetFullPath(".\\..\\Yunt.Jobs") + "\\" + job.NodeID + "\\" + jobid + "\\" + job.Name + ".dll";
            //var dir = new DirectoryInfo(Path.GetFullPath(".\\..\\Yunt.Jobs") + "\\" + job.NodeID + "\\" + jobid);
            //if (!File.Exists(Path.GetFullPath(".\\..\\Yunt.Jobs") + "\\" + job.NodeID + "\\" + jobid))
            //    dir.Create();
           if(!File.Exists(path))
